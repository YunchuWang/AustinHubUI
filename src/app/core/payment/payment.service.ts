...
export class PaymentService {
  ...
  public makePayment(nonce: string, transactionAmount: string): Observable<any> {
  ...
  public getClientToken(): Observable<any> {
    return this.httpClient.get(API_PREFIX_PATH + this.PAYMENT_BASE_URL + this.CLIENT_TOKEN_RESOURCE_URL);
  }
}
